...
public class HomeController {
    ...
    @ResponseBody
    @RequestMapping("/day/bull")
    public String dayBull() {
        ...
        if (!Constants.OPERATION_LOCKED) {
            try {
                ...
                return generateHtmlDayTrade("Day Trade US Stock Bull");
            } finally {
    ...
    @ResponseBody
    @RequestMapping("/day/bear")
    public String dayBear() {
        ...
        if (!Constants.OPERATION_LOCKED) {
            try {
                ...
                return generateHtmlDayTrade("Day Trade US Stock Short");
            } finally {
                Constants.OPERATION_LOCKED = false;
            }
        } else {
    ...
    private String generateHtmlDayTrade(String title) {
        StringBuilder html = new StringBuilder();
        html.append("<html><head><title>" + title + "</title>" +
                "<link href=\"data:image/png;base64,\" rel=\"icon\">"+
                "<link rel=\"apple-touch-icon\" href=\"data:image/png;base64,\"/>"+
        ...
        ResultReport resultReport = scanJob.runScan();
        if(resultReport != null) {
            Map<String, List<StockResult>> resultMap =  resultReport.getResultMap();
            if (resultMap != null && resultMap.size() > 0) {
                for (Map.Entry<String, List<StockResult>> entry : resultMap.entrySet()) {
                    ...
                    for(StockResult stock : stockResults) {
                        ...
                        html.append("<br><img style=\"white-space: nowrap;\" src=\"http://image.sinajs.cn/newchart/v5/usstock/min/" + stock.getSymbol() + ".gif\">");
                        html.append("<img style=\"white-space: nowrap;\" src=\"http://image.sinajs.cn/newchart/v5/usstock/daily/" + stock.getSymbol() + ".gif\">");
                        html.append("</div>");
                    }
                }
            } else {
